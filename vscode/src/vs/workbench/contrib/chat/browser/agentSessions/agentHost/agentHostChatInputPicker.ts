...
function getAutoApproveHover(value: unknown | undefined, fallback: string | undefined): string {
	switch (value) {
		case ChatPermissionLevel.Default:
			return localize('agentHostChatInputPicker.defaultApprovalsHover', "Frame AI asks before running tools unless your configured settings allow the tool.");
		...
		case ChatPermissionLevel.AutoApprove:
			return localize('agentHostChatInputPicker.autoApproveHover', "Frame AI runs all tools without asking for approval.");
		case ChatPermissionLevel.Autopilot:
			return localize('agentHostChatInputPicker.autopilotApprovalsHover', "Frame AI runs tools without asking for approval and continues until the task is done.");
	}
