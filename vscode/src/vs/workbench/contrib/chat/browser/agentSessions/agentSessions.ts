...
export function getAgentSessionProviderName(provider: AgentSessionTarget): string {
	switch (provider) {
		...
		case AgentSessionProviders.Background:
			return localize('chat.session.providerLabel.background', "local agent CLI");
		case AgentSessionProviders.Cloud:
		...
		case AgentSessionProviders.Growth:
			return 'Growth';
		case AgentSessionProviders.AgentHostCopilot:
			return localize('chat.session.providerLabel.agentHostCopilot', "Local Agent");
		default:
			return provider;
	}
}
...
export function getAgentSessionProviderDescription(provider: AgentSessionTarget): string {
	switch (provider) {
		...
		case AgentSessionProviders.Cloud:
			return localize('chat.session.providerDescription.cloud', "Cloud agent sessions are not available in Frame. Use local Frame AI instead.");
		case AgentSessionProviders.Claude:
		case AgentSessionProviders.AgentHostClaude:
			return localize('chat.session.providerDescription.claude', "Claude agent sessions are not available in Frame. Use local Frame AI instead.");
		case AgentSessionProviders.Codex:
			return localize('chat.session.providerDescription.codex', "Codex sessions are not available in Frame. Use local Frame AI instead.");
		case AgentSessionProviders.AgentHostCodex:
			return localize('chat.session.providerDescription.agentHostCodex', "Codex agent sessions are not available in Frame. Use local Frame AI instead.");
		case AgentSessionProviders.Growth:
			return localize('chat.session.providerDescription.growth', "Learn about Frame AI.");
		case AgentSessionProviders.AgentHostCopilot:
			return localize('chat.session.providerDescription.agentHostCopilot', "Agent host sessions are not available in Frame. Use local Frame AI instead.");
		default:
			return '';
	}
}
