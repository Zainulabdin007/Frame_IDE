...
const chatViewContainer: ViewContainer = Registry.as<IViewContainersRegistry>(ViewExtensions.ViewContainersRegistry).registerViewContainer({
	...
	title: localize2('chat.viewContainer.label', "Frame"),
	icon: chatViewIcon,
...
const chatViewDescriptor: IViewDescriptor = {
	...
	name: localize2('chat.viewContainer.label', "Frame"),
...
export class ChatCompatibilityNotifier extends Disposable implements IWorkbenchContribution {
	...
	private registerWelcomeView(chatExtension: IExtension) {
		...
		const mainMessage = localize('chatFailErrorMessage', "Chat failed to load because the installed version of Frame AI Chat extension is not compatible with this version of {0}. Please ensure that Frame AI Chat extension is up to date.", this.productService.nameLong);
