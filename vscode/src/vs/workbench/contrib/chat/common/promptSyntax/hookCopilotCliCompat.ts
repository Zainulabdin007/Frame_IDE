...
/**
 * Cached inverse mapping from HookType to local agent CLI hook type name.
...
/**
 * Resolves a local agent CLI hook type name to our abstract HookType.
 */
...
/**
 * Gets the local agent CLI hook type name for a given abstract HookType.
 * Returns undefined if the hook type is not supported in local agent CLI.
 */
