...
/**
 * Vendor id used for the built-in Frame AI language model provider. Treated as the default
...
/**
 * Vendor ids of the BYOK language-model providers that ship in-built with the Frame AI
...
const languageModelChatProviderType = {
	...
	properties: {
		...
		managementCommand: {
			type: 'string',
			description: localize('vscode.extension.contributes.languageModels.managementCommand', "A command to manage the language model chat provider, e.g. 'Manage Frame AI models'. This is used in the chat model picker. If not provided, a gear icon is not rendered during vendor selection."),
			deprecated: true,
