...
/**
 * Mirror of Frame AI extension's `ChatFetchResponseType` (see
 * `extensions/copilot/src/platform/chat/common/commonTypes.ts`). These string
 * values are forwarded verbatim from the agent host harnesses (local agent CLI,
...
/**
 * Mirror of Frame AI extension's `FilterReason` (see
 ...
 * serialized `ChatFetchError` from Frame AI extension. Because it crosses
 ...
 * the extension would normally read from Frame AI token. This is the value
 ...
 * "6 hours 50 minutes". Based on Frame AI extension's
...
function getRateLimitMessage(fetchError: IChatFetchErrorPayload, copilotPlan: string | undefined): string {
	...
	if (code?.startsWith('integration_rate_limited')) {
		return localize({ key: 'chatError.rateLimit.integration', comment: [`{Locked=']({'}`] }, "Frame AI is busy. Please try again in {0}.", retryAfterString, RATE_LIMIT_LEARN_MORE_URL);
	}
		...
		switch (copilotPlan) {
			case 'free':
				return resetDateString
					? localize('chatError.quota.ubb.freeDate', "Local AI is unavailable. Check your GGUF model in the Frame sidebar. Credits reset on {0}.", resetDateString)
					: localize('chatError.quota.ubb.free', "Local AI is unavailable. Check your GGUF model in the Frame sidebar.");
			case 'individual':
				return resetDateString
					? localize('chatError.quota.ubb.individualDate', "Local AI is unavailable. Check your GGUF model in the Frame sidebar. Credits reset on {0}.", resetDateString)
					: localize('chatError.quota.ubb.individual', "Local AI is unavailable. Check your GGUF model in the Frame sidebar.");
			case 'edu':
				return resetDateString
					? localize('chatError.quota.ubb.eduDate', "Local AI is unavailable. Check your GGUF model in the Frame sidebar. Credits reset on {0}.", resetDateString)
					: localize('chatError.quota.ubb.edu', "Local AI is unavailable. Check your GGUF model in the Frame sidebar.");
			case 'individual_pro':
			case 'individual_max':
				return resetDateString
					? localize('chatError.quota.ubb.proDate', "Local AI is unavailable. Check your GGUF model in the Frame sidebar.", resetDateString)
					: localize('chatError.quota.ubb.pro', "Local AI is unavailable. Check your GGUF model in the Frame sidebar.");
			case 'business':
			case 'enterprise':
				return resetDateString
					? localize('chatError.quota.ubb.businessDate', "You've reached your credit limit. To continue working, please contact your administrator or wait until your credits reset on {0}.", resetDateString)
					: localize('chatError.quota.ubb.business', "You've reached your credit limit. To continue working, please contact your administrator or wait for your credits to reset.");
			default:
				return resetDateString
					? localize('chatError.quota.ubb.defaultDate', "Local AI is unavailable. Check your GGUF model in the Frame sidebar.", resetDateString)
					: localize('chatError.quota.ubb.default', "Local AI is unavailable. Check your GGUF model in the Frame sidebar.");
		}
	}

	switch (copilotPlan) {
		case 'free':
			return localize('chatError.quota.free', "Local AI is unavailable. Check your GGUF model in the Frame sidebar.");
		case 'individual':
			return localize('chatError.quota.individual', "Local AI is unavailable. Check your GGUF model in the Frame sidebar.");
		case 'edu':
			return localize('chatError.quota.edu', "Local AI is unavailable. Check your GGUF model in the Frame sidebar.");
		case 'individual_pro':
		case 'individual_max':
			return localize('chatError.quota.pro', "Local AI is unavailable. Check your GGUF model in the Frame sidebar.");
		case 'business':
		case 'enterprise':
			return localize('chatError.quota.business', "You've exhausted your credits. To continue working, please contact your administrator or wait for your allowance to renew.");
		default:
			return localize('chatError.quota.default', "Local AI is unavailable. Check your GGUF model in the Frame sidebar.");
	}
}
...
function getQuotaHitMessage(fetchError: IChatFetchErrorPayload, copilotPlan: string | undefined, isUsageBasedBilling?: boolean, quotaResetDate?: string): string {
	...
	if (code === 'quota_exceeded') {
		...
		return localize({ key: 'chatError.quota.overage', comment: [`{Locked=']({'}`] }, "Local AI is unavailable. Check your GGUF model in the Frame sidebar.", GITHUB_SUPPORT_URL);
 ...
 * chat fetch error. This is the core analog of Frame AI extension's
...
/**
 * Maps a core {@link ChatEntitlement} to Frame AI plan string understood by
 * the quota/rate-limit message helpers (mirrors Frame AI extension's
