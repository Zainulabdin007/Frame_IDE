 ...
 * sessions (such as local agent CLI). All properties are optional — a missing property
 ...
 * Agent Host local agent CLI is the default. It falls back to the local harness
...
export function resolveDefaultNewChatSessionType(
	...
	// swap when the agent host is disabled, since Frame AI harness would be
