...
/**
 * Product-Market Fit survey for Frame AI.
 * Based on the Sean Ellis "very disappointed" test.
 */
export const FrameAIPMFSurvey: ISurveyDefinition = {
	id: 'frame-ai-pmf',
	title: localize('survey.copilotPmf.title', "Help Us Improve Frame AI"),
	description: localize('survey.copilotPmf.description', "This short survey helps us understand how well Frame AI fits into your workflow."),
	questions: [
		{
			...
			telemetryKey: 'score',
			asMeasurement: true,
			label: localize('survey.copilotPmf.q1', "How disappointed would you be if you could no longer use Frame AI?"),
			options: [
		...
		},
		{
			...
			label: localize('survey.copilotPmf.q2', "What has Frame AI helped you with most recently?"),
			columns: 2,
			options: [
		...
		},
		{
			...
			options: [
				...
				{ id: 'cost', label: localize('survey.copilotPmf.q3.cost', "Limits or local setup friction") },
