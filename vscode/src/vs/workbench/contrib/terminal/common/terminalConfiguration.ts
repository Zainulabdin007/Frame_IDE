...
const terminalConfiguration: IStringDictionary<IConfigurationPropertySchema> = {
	...
	[TerminalSettingId.TabsAllowAgentCliTitle]: {
		description: localize('terminal.integrated.tabs.allowAgentCliTitle', "Controls whether agentic CLIs are allowed to set the terminal tab title via escape sequences. When disabled, the configured tab title template is used instead."),
		type: 'boolean',
		default: true,
	},
