...
configurationRegistry.registerConfiguration({
	...
	properties: {
		'update.mode': {
			...
			description: localize('updateMode', "Configure whether you receive automatic updates. Frame does not use Microsoft update services; updates are disabled by default."),
			...
			enumDescriptions: [
				...
				localize('default', "Enable automatic update checks. Frame will check for updates automatically and periodically when an update service is configured.")
			],
			policy: {
				name: 'UpdateMode',
				...
				minimumVersion: '1.67',
				localization: {
					description: { key: 'updateMode', value: localize('updateMode', "Configure whether you receive automatic updates. Frame does not use Microsoft update services; updates are disabled by default."), },
					enumDescriptions: [
						{
							key: 'none',
						...
						{
							key: 'default',
							value: localize('default', "Enable automatic update checks. Frame will check for updates automatically and periodically when an update service is configured."),
						}
					]
				},
			}
