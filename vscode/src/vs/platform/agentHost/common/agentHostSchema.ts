...
export const platformRootSchema = createSchema({
	...
	[AgentHostSystemProxyEnabledConfigKey]: schemaProperty<boolean>({
		...
		description: localize('agentHost.config.systemProxyEnabled.description', "Whether chat sessions automatically discover and use the operating system's proxy configuration."),
		default: true,
	}),
